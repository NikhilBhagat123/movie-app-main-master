...
mongoose.connect('mongodb+srv://Francisco:Francisco@cluster0.y38ld2x.mongodb.net/?retryWrites=true&w=majority').then(() => {
...
const store = new mongoDbSession({
    uri: 'mongodb+srv://Francisco:Francisco@cluster0.y38ld2x.mongodb.net/?retryWrites=true&w=majority',
    collection: 'sessions'
})
...
// isAuth Middleware => this will redirect to todo if user is logged in
